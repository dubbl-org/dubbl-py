...
class Payroll:
    ...
    def update_employee_deduction(self, employee_id: str, deduction_id: str, **kwargs: Any) -> Any:
        return self._client.patch(
            f"/payroll/employees/{employee_id}/deductions/{deduction_id}",
            json={_to_camel(k): v for k, v in kwargs.items() if v is not None},
        )

    def delete_employee_deduction(self, employee_id: str, deduction_id: str) -> Any:
    ...
    def delete_run_bonus(self, run_id: str, bonus_id: str) -> Any:
    ...
    def update_leave_request(self, request_id: str, **kwargs: Any) -> Any:
        return self._client.patch(
    ...
    def update_contractor_payment(self, contractor_id: str, payment_id: str, **kwargs: Any) -> Any:
        return self._client.patch(
    ...
    def update_payslip(self, payslip_id: str, **kwargs: Any) -> Any:
        return self._client.patch(
            f"/payroll/payslips/{payslip_id}", json={_to_camel(k): v for k, v in kwargs.items() if v is not None}
        )
    ...
    def retrieve_compensation_band(self, band_id: str) -> Any:
        return self._client.get(f"/payroll/compensation/bands/{band_id}")

    def update_compensation_band(self, band_id: str, **kwargs: Any) -> Any:
        return self._client.patch(
            f"/payroll/compensation/bands/{band_id}",
            json={_to_camel(k): v for k, v in kwargs.items() if v is not None},
        )

    def delete_compensation_band(self, band_id: str) -> Any:
    ...
    def retrieve_compensation_review(self, review_id: str) -> Any:
        return self._client.get(f"/payroll/compensation/reviews/{review_id}")

    def update_compensation_review(self, review_id: str, **kwargs: Any) -> Any:
        return self._client.patch(
            f"/payroll/compensation/reviews/{review_id}",
            json={_to_camel(k): v for k, v in kwargs.items() if v is not None},
        )

    def list_compensation_review_entries(self, review_id: str) -> Any:
        return self._client.get(f"/payroll/compensation/reviews/{review_id}/entries")

    def create_compensation_review_entry(self, review_id: str, **kwargs: Any) -> Any:
        return self._client.post(
...
class AsyncPayroll:
    ...
    async def update_employee_deduction(self, employee_id: str, deduction_id: str, **kwargs: Any) -> Any:
        return await self._client.patch(
            f"/payroll/employees/{employee_id}/deductions/{deduction_id}",
            json={_to_camel(k): v for k, v in kwargs.items() if v is not None},
        )

    async def delete_employee_deduction(self, employee_id: str, deduction_id: str) -> Any:
    ...
    async def delete_run_bonus(self, run_id: str, bonus_id: str) -> Any:
    ...
    async def update_leave_request(self, request_id: str, **kwargs: Any) -> Any:
        return await self._client.patch(
            f"/payroll/leave/requests/{request_id}",
            json={_to_camel(k): v for k, v in kwargs.items() if v is not None},
        )
    ...
    async def update_contractor_payment(self, contractor_id: str, payment_id: str, **kwargs: Any) -> Any:
        return await self._client.patch(
            f"/payroll/contractors/{contractor_id}/payments/{payment_id}",
            json={_to_camel(k): v for k, v in kwargs.items() if v is not None},
        )
    ...
    async def retrieve_compensation_band(self, band_id: str) -> Any:
        return await self._client.get(f"/payroll/compensation/bands/{band_id}")

    async def update_compensation_band(self, band_id: str, **kwargs: Any) -> Any:
        return await self._client.patch(
            f"/payroll/compensation/bands/{band_id}",
            json={_to_camel(k): v for k, v in kwargs.items() if v is not None},
        )

    async def delete_compensation_band(self, band_id: str) -> Any:
    ...
    async def retrieve_compensation_review(self, review_id: str) -> Any:
        return await self._client.get(f"/payroll/compensation/reviews/{review_id}")

    async def update_compensation_review(self, review_id: str, **kwargs: Any) -> Any:
        return await self._client.patch(
            f"/payroll/compensation/reviews/{review_id}",
            json={_to_camel(k): v for k, v in kwargs.items() if v is not None},
        )

    async def list_compensation_review_entries(self, review_id: str) -> Any:
        return await self._client.get(f"/payroll/compensation/reviews/{review_id}/entries")

    async def create_compensation_review_entry(self, review_id: str, **kwargs: Any) -> Any:
        return await self._client.post(
            f"/payroll/compensation/reviews/{review_id}/entries",
            json={_to_camel(k): v for k, v in kwargs.items() if v is not None},
        )
