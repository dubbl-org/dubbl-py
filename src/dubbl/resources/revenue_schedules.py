...
class RevenueSchedules:
    ...
    def list(self, **params: Any) -> Any:
        return self._client.get("/revenue-schedules", params={_to_camel(k): v for k, v in params.items() if v is not None})
...
class AsyncRevenueSchedules:
    ...
    async def list(self, **params: Any) -> Any:
        return await self._client.get("/revenue-schedules", params={_to_camel(k): v for k, v in params.items() if v is not None})
