...
class DocumentTemplates:
    ...
    def create(self, **kwargs: Any) -> Any:
        return self._client.post("/document-templates", json={_to_camel(k): v for k, v in kwargs.items() if v is not None})
    ...
    def update(self, template_id: str, **kwargs: Any) -> Any:
        return self._client.patch(f"/document-templates/{template_id}", json={_to_camel(k): v for k, v in kwargs.items() if v is not None})
    ...
    def preview(self, template_id: str, **kwargs: Any) -> Any:
        return self._client.post(f"/document-templates/{template_id}/preview", json={_to_camel(k): v for k, v in kwargs.items() if v is not None})
...
class AsyncDocumentTemplates:
    ...
    async def create(self, **kwargs: Any) -> Any:
        return await self._client.post("/document-templates", json={_to_camel(k): v for k, v in kwargs.items() if v is not None})
    ...
    async def update(self, template_id: str, **kwargs: Any) -> Any:
        return await self._client.patch(f"/document-templates/{template_id}", json={_to_camel(k): v for k, v in kwargs.items() if v is not None})
    ...
    async def preview(self, template_id: str, **kwargs: Any) -> Any:
        return await self._client.post(f"/document-templates/{template_id}/preview", json={_to_camel(k): v for k, v in kwargs.items() if v is not None})
