...
class CRM:
    ...
    def update_deal(self, deal_id: str, **kwargs: Any) -> Any:
        return self._client.patch(f"/crm/deals/{deal_id}", json={_to_camel(k): v for k, v in kwargs.items() if v is not None})
    ...
    def update_deal_stage(self, deal_id: str, **kwargs: Any) -> Any:
        return self._client.patch(f"/crm/deals/{deal_id}/stage", json={_to_camel(k): v for k, v in kwargs.items() if v is not None})
    ...
    def create_deal_activity(self, deal_id: str, **kwargs: Any) -> Any:
        return self._client.post(f"/crm/deals/{deal_id}/activities", json={_to_camel(k): v for k, v in kwargs.items() if v is not None})
    ...
    def update_pipeline(self, pipeline_id: str, **kwargs: Any) -> Any:
        return self._client.patch(f"/crm/pipelines/{pipeline_id}", json={_to_camel(k): v for k, v in kwargs.items() if v is not None})
...
class AsyncCRM:
    ...
    async def update_deal(self, deal_id: str, **kwargs: Any) -> Any:
        return await self._client.patch(f"/crm/deals/{deal_id}", json={_to_camel(k): v for k, v in kwargs.items() if v is not None})
    ...
    async def update_deal_stage(self, deal_id: str, **kwargs: Any) -> Any:
        return await self._client.patch(f"/crm/deals/{deal_id}/stage", json={_to_camel(k): v for k, v in kwargs.items() if v is not None})
    ...
    async def create_deal_activity(self, deal_id: str, **kwargs: Any) -> Any:
        return await self._client.post(f"/crm/deals/{deal_id}/activities", json={_to_camel(k): v for k, v in kwargs.items() if v is not None})
    ...
    async def create_pipeline(self, **kwargs: Any) -> Any:
        return await self._client.post("/crm/pipelines", json={_to_camel(k): v for k, v in kwargs.items() if v is not None})
    ...
    async def update_pipeline(self, pipeline_id: str, **kwargs: Any) -> Any:
        return await self._client.patch(f"/crm/pipelines/{pipeline_id}", json={_to_camel(k): v for k, v in kwargs.items() if v is not None})
