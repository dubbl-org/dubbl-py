...
class PurchaseRequisitions:
    ...
    def list(self, **params: Any) -> Any:
        return self._client.get("/purchase-requisitions", params={_to_camel(k): v for k, v in params.items() if v is not None})

    def create(self, **kwargs: Any) -> Any:
        body = {_to_camel(k): v for k, v in kwargs.items() if v is not None}
        return self._client.post("/purchase-requisitions", json=body)

    def retrieve(self, requisition_id: str) -> Any:
        return self._client.get(f"/purchase-requisitions/{requisition_id}")

    def update(self, requisition_id: str, **kwargs: Any) -> Any:
        body = {_to_camel(k): v for k, v in kwargs.items() if v is not None}
        return self._client.patch(f"/purchase-requisitions/{requisition_id}", json=body)

    def delete(self, requisition_id: str) -> Any:
        return self._client.delete(f"/purchase-requisitions/{requisition_id}")

    def approve(self, requisition_id: str) -> Any:
        return self._client.post(f"/purchase-requisitions/{requisition_id}/approve")

    def reject(self, requisition_id: str) -> Any:
        return self._client.post(f"/purchase-requisitions/{requisition_id}/reject")

    def convert(self, requisition_id: str) -> Any:
...
class AsyncPurchaseRequisitions:
    ...
    async def list(self, **params: Any) -> Any:
        return await self._client.get("/purchase-requisitions", params={_to_camel(k): v for k, v in params.items() if v is not None})

    async def create(self, **kwargs: Any) -> Any:
        body = {_to_camel(k): v for k, v in kwargs.items() if v is not None}
        return await self._client.post("/purchase-requisitions", json=body)

    async def retrieve(self, requisition_id: str) -> Any:
        return await self._client.get(f"/purchase-requisitions/{requisition_id}")

    async def update(self, requisition_id: str, **kwargs: Any) -> Any:
        body = {_to_camel(k): v for k, v in kwargs.items() if v is not None}
        return await self._client.patch(f"/purchase-requisitions/{requisition_id}", json=body)

    async def delete(self, requisition_id: str) -> Any:
        return await self._client.delete(f"/purchase-requisitions/{requisition_id}")

    async def approve(self, requisition_id: str) -> Any:
        return await self._client.post(f"/purchase-requisitions/{requisition_id}/approve")

    async def reject(self, requisition_id: str) -> Any:
        return await self._client.post(f"/purchase-requisitions/{requisition_id}/reject")

    async def convert(self, requisition_id: str) -> Any:
