...
class Admin:
    ...
    def update_user(self, user_id: str, **kwargs: Any) -> Any:
        return self._client.patch(
...
class AsyncAdmin:
    ...
    async def email_preview(self, **params: Any) -> Any:
        return await self._client.get(
            "/admin/email-preview", params={_to_camel(k): v for k, v in params.items() if v is not None}
        )

    async def list_organizations(self, **params: Any) -> Any:
        return await self._client.get(
            "/admin/organizations", params={_to_camel(k): v for k, v in params.items() if v is not None}
        )

    async def retrieve_organization(self, organization_id: str) -> Any:
        return await self._client.get(f"/admin/organizations/{organization_id}")

    async def update_organization(self, organization_id: str, **kwargs: Any) -> Any:
        return await self._client.patch(
            f"/admin/organizations/{organization_id}",
            json={_to_camel(k): v for k, v in kwargs.items() if v is not None},
        )

    async def cancel_organization_stripe(self, organization_id: str) -> Any:
    ...
    async def usage(self, **params: Any) -> Any:
        return await self._client.get(
    ...
    async def update_user(self, user_id: str, **kwargs: Any) -> Any:
        return await self._client.patch(
            f"/admin/users/{user_id}",
            json={_to_camel(k): v for k, v in kwargs.items() if v is not None},
        )
